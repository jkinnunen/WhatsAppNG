...
### Версия 1.8.0 (2026-05-01)

**Добавлено:**
- Диалог пожертвования при установке дополнения

**Изменено:**
- Навигация (Alt+1, Alt+2, Alt+D) более устойчива к изменениям интерфейса WhatsApp

**Исправлено:**
- Enter и Shift+Enter не работали при отключённом фильтре подсказок
- Клавиша Enter не работала в файловых диалогах и списке бесед
- Переключение фильтра номеров в списке бесед не обновлялось корректно
- Улучшен финский перевод и документация

### Версия 1.7.1 (2026-04-10)

**Исправлено:**
- Порядок воспроизведения клавиши Enter: Исправлена проблема, при которой голосовые сообщения больше не воспроизводились при нажатии клавиши Enter
  - Проверка кнопки теперь выполняется только вне списка сообщений
  - Голосовые сообщения воспроизводятся корректно при навигации по списку сообщений

### Версия 1.7.0 (2026-04-10)

**Добавлено:**
- Финский перевод: Полная поддержка финского языка

**Исправлено:**
- Клавиша Enter на кнопках: Теперь Enter правильно передаётся, когда фокус на кнопке
  - Раньше нажатие Enter на любой кнопке в WhatsApp запускало воспроизведение аудио
  - Теперь кнопки работают корректно (например, кнопка сохранения файла работает как ожидается)
