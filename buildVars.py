...
- Escape key now passes through correctly."""),
	...
	addon_url="https://github.com/nunotfc/whatsAppNG",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/nunotfc/whatsAppNG",
...
pythonSources = [
	"addon/appModules/whatsapp_root.py",
]
